...
%%%% VIA 11 Design matrix
% Loading table with information about HGR status
tbl = readtable(['/mnt/projects/VIA_MCA/VIA11/Clean_VIA11_Flanker_23_04.xlsx']);
...
for subjectIdx = 1:height(tbl)
   ...
   try 
       ...
       GCM{end + 1} = ['/mnt/projects/VIA_MCA/VIA11/MATLAB_VIA11/DCM/Model2/DCM_Model2_' currsubject '.mat'];
